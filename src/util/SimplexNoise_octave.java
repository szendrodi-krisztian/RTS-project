 ...
 *
 */
public final class SimplexNoise_octave {  // Simplex noise in 2D, 3D and 4D

    public final static int RANDOMSEED = 0;
    private final static int NUMBEROFSWAPS = 10;
    ...
    private final static Grad grad4[] = {new Grad(0, 1, 1, 1), new Grad(0, 1, 1, -1), new Grad(0, 1, -1, 1), new Grad(0, 1, -1, -1),
        ...
        new Grad(-1, 1, 1, 0), new Grad(-1, 1, -1, 0), new Grad(-1, -1, 1, 0), new Grad(-1, -1, -1, 0)};
    private final static short p_supply[] = {151, 160, 137, 91, 90, 15, //this contains all the numbers between 0 and 255, these are put in a random order depending upon the seed
    ...
    // 2D simplex noise
    public final float noise(float xin, float yin) {
        float n0, n1, n2;
        float s = (xin + yin) * F2;
    ...
    // 3D simplex noise
    public final float noise(float xin, float yin, float zin) {
    ...
    public final float noise(float x, float y, float z, float w) {
    ...
    private final static class Grad {
